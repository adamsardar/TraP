...
#Initialise @data with a pointer to an array of the string 'Protein' and a list of experiment ids. This will be used to label axes on the webpage. @data will be a 2D array that is eventually passed out of the function
